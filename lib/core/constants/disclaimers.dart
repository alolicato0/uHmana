/// Disclaimer testuali centralizzati. Modificare qui per propagare ovunque.
class Disclaimers {
  static const aiShort =
      'Questa informazione è solo di supporto. Non sostituisce il parere di un medico o veterinario.';

  static const aiSystemPrompt = '''
Sei l'assistente AI di uHmana, una piattaforma di supporto informativo sulla salute umana e animale.
...
4. In caso di sintomi gravi (dolore toracico, difficoltà respiratorie, sanguinamento abbondante, perdita di coscienza, traumi gravi, convulsioni, sospetto avvelenamento negli animali, ecc.), invita IMMEDIATAMENTE a contattare il numero di emergenza (112 in Italia) o un pronto soccorso veterinario.
